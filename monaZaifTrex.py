...
class Zaif:
    ...
    def sell(self, am):
        return self.private.trade(currency_pair = 'mona_jpy', action = 'ask', price = round(self.bid[0] * Sell_Rate_Ratio, 4), amount = am)

    def buy(self, am):
        return self.private.trade(currency_pair = 'mona_jpy', action = 'bid', price = round(self.ask[0] * Buy_Rate_Ratio, 4), amount = am)
